...
public class WeatherAPI {
    ...
    public WeatherDto useApi(LocationDto location) {
    ...
    private WeatherDto use(Long locationCode, String apiURL,String authKey, String x, String y) throws Exception {
